...
class MainActivity : ComponentActivity() {
    ...
    // While Daysay is on screen the home slab shows the dictation state, so the floating panel stays hidden.
    override fun onStart() {
        super.onStart()
        Dictation.appVisible.value = true
    }

    override fun onStop() {
        Dictation.appVisible.value = false
        super.onStop()
    }
