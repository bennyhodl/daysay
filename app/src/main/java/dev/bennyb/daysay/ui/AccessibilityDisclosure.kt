...
fun AccessibilityDisclosureDialog(onAgree: () -> Unit, onDismiss: () -> Unit) {
    AlertDialog(
        ...
        title = { Text("How Daysay uses the accessibility service") },
        text = {
            Column {
                Text(
                    "Daysay asks for the accessibility service for three things and nothing else.",
                ...
                Text(
                    "The service does not read, store, or send the content of your screen, your keystrokes, or " +
                        ...
                        "transcript, and only when you choose a remote model or the cleanup pass, and only to " +
